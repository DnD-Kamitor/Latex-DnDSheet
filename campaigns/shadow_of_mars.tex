...
\item \textbf{Tribune Lucius Valerius Maximus} – A mysterious figure from Rome with a hidden agenda
\item \textbf{Vercingetorix the Red} – Germanic chieftain and reluctant ally
\item \textbf{Senator Gaius Cassius Brutus} – Roman aristocrat with revolutionary ambitions
\end{itemize}

\section{NPC OGAS Framework}

\textit{Using Guy Sclanders' OGAS method: Objective, Goal, Agenda, Secret}

\subsection{Legate Marcus Aurelius Corvinus}

\textbf{Objective:} Secure a military triumph and consulship in Rome

\textbf{Goal:} Possess the Spear of Mars as proof of his frontier victory

\textbf{Agenda:} Use the artifact to gain Senate favor and advancement

\textbf{Secret:} Drowning in gambling debts to Senator Brutus who now owns him

\textit{Personality:} Blunt, aggressive, military mindset. Speaks in short commands. Reacts with anger first. Will sacrifice subordinates to save himself.

\subsection{Augur Cassia Liviana}

\textbf{Objective:} Prevent divine catastrophe and protect Rome from Mars' wrath

\textbf{Goal:} Destroy the Spear before it corrupts anyone else

\textbf{Agenda:} Guide the party toward the right choice without forcing them

\textbf{Secret:} She's Mars' daughter (demigod); can feel the spear calling to her bloodline

\textit{Personality:} Quiet, intense, cryptic. Speaks in riddles. Reacts with sadness. Will sacrifice herself to stop the spear.

\subsection{Centurion Titus Varro}

\textbf{Objective:} Survive his final year and retire with honor

\textbf{Goal:} Keep his soldiers alive and maintain order

\textbf{Agenda:} Support whoever seems most competent

\textbf{Secret:} Knows Legate is corrupt but can't prove it; 20 years made him complicit

\textit{Personality:} Pragmatic, weary, dark humor. Speaks profanely but with wisdom. Will choose his men over his commander.

\subsection{Tribune Lucius Valerius Maximus}

\textbf{Objective:} Earn respect as a "real Roman" despite aristocratic birth

\textbf{Goal:} Complete secret mission from Brutus (destroy the spear)

\textbf{Agenda:} Manipulate party into destroying it so he gets credit

\textbf{Secret:} Brutus' illegitimate son, desperate to prove his worth

\textit{Personality:} Overconfident, theatrical, masks insecurity. Quotes philosophers condescendingly. Coward beneath bravado.

\subsection{Vercingetorix the Red}

\textbf{Objective:} Protect his people from Roman expansion

\textbf{Goal:} Recover the Spear (killed his grandfather, tribe's enemy)

\textbf{Agenda:} Use party to get past defenses, take spear by force or alliance

\textbf{Secret:} Dying from wasting disease; this is his last campaign

\textit{Personality:} Noble warrior, tired of war. Speaks poetically. Respects strength and honesty. Prefers honorable combat.

\subsection{Senator Gaius Cassius Brutus}

\textbf{Objective:} "Restore the Republic" (overthrow Emperor, install himself)

\textbf{Goal:} Acquire Spear to assassinate Emperor during Triumph

\textbf{Agenda:} Manipulate everyone as pawns; eliminate witnesses

\textbf{Secret:} Made pacts with three gods (Jupiter, Pluto, Bellona) promising them Mars' power

\textit{Personality:} Charismatic sociopath, believes he's Rome's savior. Uses rhetoric and Roman values. Flees when threatened.

\subsection{Mars (God of War)}

\textbf{Objective:} Reclaim honor after mortals stole his weapon

\textbf{Goal:} Make party understand consequences of defying a god

\textbf{Agenda:} Test their worth—strong become champions, weak are destroyed

\textbf{Secret:} Secretly proud they destroyed the corrupted spear

\textit{Personality:} Wrathful but honorable. Speaks imperiously. Respects courage. Violence is prayer to him.

\subsection{Using OGAS in Play}

When NPCs appear:
\begin{enumerate}
\item Start with \textbf{Goal} - what they want THIS SESSION
\item Use \textbf{Agenda} - HOW they'll try to get it
\item Reveal \textbf{Objective} through multiple sessions
\item Drop \textbf{Secret} hints for clever players
\end{enumerate}

\textit{Example: Legate in Session 1}
\begin{itemize}
\item Goal: Get spear → Direct orders
\item Agenda: Authority → Threatens court-martial
\item Objective leak: "This will echo to Rome"
\item Secret hint: Cassia whispers, "He's not his own master"
\end{itemize}

\textbf{If party goes off-script:} NPCs pursue OGAS regardless. This makes the world reactive and alive.
