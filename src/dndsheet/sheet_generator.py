...
def generate_character_sheet_latex(character: Character) -> str:
    ...
    template = env.get_template("character_sheet.tex.j2")

    # Prepare context with all necessary data
    # Get all skills in a consistent order
...
def generate_and_compile_character_sheet(
    ...
    """
    Generate and compile a character sheet to PDF.
    ...
    try:
        ...
        return False, f"Failed to generate LaTeX: {str(e)}", None
    ...
    try:
        ...
        return False, f"Failed to write .tex file: {str(e)}", None

    # Compile to PDF
    success, message, pdf_path = compile_to_pdf(
        tex_file,
